...
## Filter by POS for further applications

We annotate the first paragraphs of the corpus, extract proper nouns (person names, locations etc.), and compute significance of co-occurrence of them.
