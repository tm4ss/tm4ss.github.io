...
Up to this point, we dropped features occurring less than 5 time in our data. Let's see if we include more features by decreasing the minimum frequency.
...
Can you see how the position of FORGEIN affairs related content switches from the beginning to the end around the turn to the 20th century?
