...
We read a CSV containing 231 "State of the Union" addresses of the presidents of the United States. The texts are freely available from http://stateoftheunion.onetwothree.net. 
...
```
```{r eval=T, echo=F}
cat(paste0(substring(texts(corpus)[1], 0, 155), "..."))
```
...
Success!!! We now have `r ndoc(corpus)` speeches for further analysis available in a convenient tm corpus object!
