...
``` {r echo=FALSE}
exampleIds <- c(2, 100, 200)
print(paste0(exampleIds[1], ": ", substr(texts(corpus)[exampleIds[1]], 0, 400), '...'))
print(paste0(exampleIds[2], ": ", substr(texts(corpus)[exampleIds[2]], 0, 400), '...'))
print(paste0(exampleIds[3], ": ", substr(texts(corpus)[exampleIds[3]], 0, 400), '...'))
```
...
topicToFilter <- grep('child', topicNames)[2] 
topicThreshold <- 0.2
...
Our filtered corpus contains `r ndoc(filteredCorpus)` documents related to the topic `r topicToFilter` to at least 20 %.
