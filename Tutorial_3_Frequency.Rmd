...
Then, we create a corpus object again. Moreover, we apply different preprocessing steps to the corpus text. Lowercase transformation is performed and a set of English stop-words is removed. `removePunctuation` leaves only alphanumeric characters in the text. `removeNumbers` removes numeric characters. `stripWhitespace` collapses sequences of two or more whitespace characters to a single one.
